'use strict';
fetch(("https://discord-web-api.glitch.me/discord/user/488085754602455040"), {
  method : "GET",
  mode : "cors"
...
'use strict';
fetch(("https://discord-web-api.glitch.me/discord/user/505233837106790401"), {
  method : "GET",
  mode : "cors"
}).then(function(responseJson) {
  if (responseJson.ok) {
...
'use strict';
fetch(("https://discord-web-api.glitch.me/discord/user/854181777786929183"), {
  method : "GET",
  mode : "cors"
}).then(function(responseJson) {
  if (responseJson.ok) {
